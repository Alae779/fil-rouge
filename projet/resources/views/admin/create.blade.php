@section('title', 'Add New speciality | MediSlot')
...
<main class="flex-1 max-w-[1440px] mx-auto w-full px-6 py-8">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <a class="hover:text-primary transition-colors" href="{{ url('/admin/speciality') }}">SpecialitIES</a>
        <span class="material-symbols-outlined text-xs">chevron_right</span>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight mb-1">Add New Speciality</h1>
            <p class="text-gray-500 dark:text-gray-400">Fill in the details below to create a new speciality slot.</p>
        </div>
        <a href="{{ route('admin_specialities') }}"
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('store_speciality') }}" class="p-8">
            @csrf
